...
# ref: https://pennylane.ai/qml/demos/tutorial_learning_few_data/
...
class Training_Set():
    ...
    def binned_descriptors(self, n_bin, D_all):
...
for idx in range(len(Training_Sets_All[0])):
	D_all.append(Training_Sets_All[0][idx].descriptors_lmbtr)
...
results_df.to_pickle("/work/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/qcnn_results_df_v21")
np.save("/work/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/qcnn_final_weights_v21", final_weights)
np.save("/work/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/qcnn_final_weights_last_v21", final_weights_last)
