...
#final_rot_weights = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QDNN_v23/v23_03/qdnn_final_rot_weights_v23.npy")
final_weights = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QDNN_v23/v23_03/qdnn_final_weights_v23.npy")
#final_weights_last = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QDNN_v23/v23_03/qdnn_final_weights_last_v23.npy")
results_df = pd.read_pickle("/home/hsukaicheng/NiCoTiZrHf/train_energies/QDNN_v23/v23_03/qdnn_results_df_v23")
...
if True:
    x1=results_df["train_out"].iloc[56999]
    y1=results_df["E_train"].iloc[56999]
    x2=results_df["test_out"].iloc[56999]
    y2=results_df["E_test"].iloc[56999]
    #x1=x1*27.211
    #x2=x2*27.211
    #y1=y1*27.211
    #y2=y2*27.211
