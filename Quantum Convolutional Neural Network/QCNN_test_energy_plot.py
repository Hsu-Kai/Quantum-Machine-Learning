...
#final_rot_weights = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/v21_01/qcnn_final_rot_weights_v21.npy")
final_weights = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/v21_01/qcnn_final_weights_v21.npy")
final_weights_last = np.load("/home/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/v21_01/qcnn_final_weights_last_v21.npy")
results_df = pd.read_pickle("/home/hsukaicheng/NiCoTiZrHf/train_energies/QCNN_v21/v21_01/qcnn_results_df_v21")
...
if True:
    x1=results_df["train_out"].iloc[57999]
    y1=results_df["E_train"].iloc[57999]
    x2=results_df["test_out"].iloc[57999]
    y2=results_df["E_test"].iloc[57999]
    #x1=x1*27.211
    #x2=x2*27.211
    #y1=y1*27.211
    #y2=y2*27.211
